                    ...
                    <div class="col-12">
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="gameFile" multiple>
                            </div>
                            <div class="form-group">
                                <label for="gameAvatar">Game Avatar</label>
                                <input type="file" class="form-control-file" id="gameAvatar" multiple>
                            </div>
                         <div class="form-group">
                                <label for="language">Game Trailer link </label>
                                <input type="text" class="form-control" id="language" placeholder="Enter link of the trailer game ">
                            </div>

                            <div class="form-group">
                                <label for="language">Language</label>
                                <input type="text" class="form-control" id="language" placeholder="Enter game language">
                            </div>

                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea class="form-control" id="description" rows="3" placeholder="Enter game description"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Minimum CPU" id="minCpu">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Minimum RAM" id="minRam">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Minimum GPU" id="minGpu">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Maximum CPU" id="maxCpu">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Maximum RAM" id="maxRam">
                                    </div>
                                    <div class="col">
                                        <input type="text" class="form-control" placeholder="Maximum GPU" id="maxGpu">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="action" value="action">
                                        <label class="form-check-label" for="action">Action</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="rpg" value="rpg">
                                        <label class="form-check-label" for="rpg">RPG</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="detective" value="detective">
